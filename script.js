...
const finalTempo = new Audio('/sons/beep.mp3')
...
// menu adicionar item a lista container

const botaoNovaTarefa = document.querySelector('.app__nova-tarefa-botao')
const menuNovaTarefa = document.querySelector('.app__lista-adicionar-container')

botaoNovaTarefa.addEventListener('click', () => {
    menuNovaTarefa.classList.toggle('app__lista-adicionar-container--ativo')
})
